...
const ViewNPDP = () => {
  ...
  req.mailing_list.project_coordinators.map((x)=>{x.date=x.date.substring(0,10)});
      ...
      >
        Add Budget Item
          ...
          <FormLabel>Project coordinator</FormLabel>
            {values.mailing_list.project_coordinators.map((a) => (
              <VStack key={a.id}>
                <FormControl>
                  <Input
                    type="text"
          ...
          <FormLabel>Comment by Project Coordinator</FormLabel>
            ...
            <FormControl id="amountApproved" isRequired mb={4}>
              ...
              <Field as={Input} type='number' name="amount_approved" readOnly />              
            </FormControl>
