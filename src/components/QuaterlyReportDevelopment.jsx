...
const QuaterlyReportDevelopment = () => {
  ...
  const handleDeleteRow = (tableType, index) => {
    setFormData((prevData) => ({
      ...
      activitiesSection: {
        ...prevData.activitiesSection,
        [tableType]: prevData.activitiesSection[tableType].filter(
          (_, i) => i !== index
        ),
      },
    }));
      ...
      <Box p={8}>
        ...
        <VStack spacing={6} align="start">
          ...
          <Box border="1px solid #ccc" borderRadius="lg" p={4} mb={8}>
            <FormControl id="objectives">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleChange("activitiesSection.objectives", e.target.value)
                }
              />
            </FormControl>
            ...
            <FormControl id="outcome">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleChange("activitiesSection.outcome", e.target.value)
                }
              />
            </FormControl>
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>
                    Qualitative & Quantitative Data & Intermediate Outcomes
                  </Th>
                  <Th></Th>
                </Tr>
              </Thead>
                  ...
                  <Tr key={index}>
                    <Td>
                      <Input
                        ...
                        onChange={(e) =>
                          handleChange(
                            `activitiesSection.activityTable[${index}].month`,
                            e.target.value
                          )
                        }
                      />
                    ...
                    <Td>
                      <Input
                        ...
                        onChange={(e) =>
                          handleChange(
                            `activitiesSection.activityTable[${index}].summary`,
                            e.target.value
                          )
                        }
                      />
                    ...
                    <Td>
                      <Input
                        ...
                        onChange={(e) =>
                          handleChange(
                            `activitiesSection.activityTable[${index}].data`,
                            e.target.value
                          )
                        }
                      />
            ...
            <Button
              colorScheme="teal"
              mt={4}
              onClick={() => handleAddRow("activityTable")}
            >
              Add Row
            </Button>
                  ...
                  <Tr key={index}>
                    <Td>
                      <Input
                        ...
                        onChange={(e) =>
                          handleChange(
                            `activitiesSection.notHappenTable[${index}].reason`,
                            e.target.value
                          )
                        }
                      />
                    ...
                    <Td>
                      <Input
                        ...
                        onChange={(e) =>
                          handleChange(
                            `activitiesSection.notHappenTable[${index}].explanation`,
                            e.target.value
                          )
                        }
                      />
            ...
            <Button
              colorScheme="teal"
              mt={4}
              onClick={() => handleAddRow("notHappenTable")}
            >
              Add Row
            </Button>
            ...
            <Table variant="simple">
              ...
              <Tbody>
                {formData.activitiesSection.projectChangesTable.map(
                  (row, index) => (
                    <Tr key={index}>
                      <Td>
                        <Input
                          ...
                          onChange={(e) =>
                            handleChange(
                              `projectChangesTable[${index}].changes`,
                              e.target.value
                            )
                          }
                        />
                      ...
                      <Td>
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleChange(
                              `projectChangesTable[${index}].explanations`,
                              e.target.value
                            )
                          }
                        />
                      ...
                      <Td>
                        <IconButton
                          ...
                          icon={<DeleteIcon />}
                          onClick={() =>
                            handleDeleteRow("projectChangesTable", index)
                          }
                        />
                      </Td>
                    </Tr>
            ...
            <Button
              colorScheme="teal"
              mt={4}
              onClick={() => handleAddRow("projectChangesTable")}
            >
              Add Row
            </Button>
            ...
            <Table variant="simple">
              ...
              <Tbody>
                {formData.activitiesSection.lessonsLearnedTable.map(
                  (row, index) => (
                    <Tr key={index}>
                      <Td>
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleChange(
                              `lessonsLearnedTable[${index}].lessons`,
                              e.target.value
                            )
                          }
                        />
                      ...
                      <Td>
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleChange(
                              `lessonsLearnedTable[${index}].differences`,
                              e.target.value
                            )
                          }
                        />
                      ...
                      <Td>
                        <IconButton
                          ...
                          icon={<DeleteIcon />}
                          onClick={() =>
                            handleDeleteRow("lessonsLearnedTable", index)
                          }
                        />
                      </Td>
                    </Tr>
            ...
            <Button
              colorScheme="teal"
              mt={4}
              onClick={() => handleAddRow("lessonsLearnedTable")}
            >
              Add Row
            </Button>
          </Box>
          ...
          <Button
            ...
            mt={4}
            ml="auto"
            onClick={() => handleAddActivitiesSection()}
          >
            Add Objectives
          </Button>
            ...
            <Tbody>
              {formData.payments.map((payment, index) => (
                <Tr key={index}>
                  ...
                  <Td>{payment.totalExpenditure}</Td>
                </Tr>
              ))}
              <Tr>
          ...
          <Button
            onClick={() => handleAddPaymentsOrRecieptsRow("payments")}
            colorScheme="teal"
          >
            Add Row
          </Button>
