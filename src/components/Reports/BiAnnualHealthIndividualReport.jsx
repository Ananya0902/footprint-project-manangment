...
const BiAnnualHealthIndividualReport = () => {
  const initialValues = {
    date: '',
    reportingPeriodFrom: '',
    reportingPeriodTo: '',
  ...
  return (
    <Box p={4}>
      <Heading as="h1" mb={6}>
        BI-ANNUAL REPORT – SUPPORT FOR HEALTH - INDIVIDUAL PROJECT
      </Heading>
    ...
    >
      ...
      <FormErrorMessage>
        {form.errors.beneficiaryName}
              ...
              <Field name="natureOfIllHealth">
                {({ field, form }) => (
                  <FormControl
                    isInvalid={
                      form.errors.natureOfIllHealth &&
                      form.touched.natureOfIllHealth
                    }
                  >
                    <FormLabel>Nature of Ill Health</FormLabel>
                    <Input type="text" {...field} />
                    <FormErrorMessage>
                      {form.errors.natureOfIllHealth}
                    </FormErrorMessage>
              ...
              <Field name="initiativesTaken">
                {({ field, form }) => (
                  <FormControl
                    isInvalid={
                      form.errors.initiativesTaken &&
                      form.touched.initiativesTaken
                    }
                  >
                    <FormLabel>
                      Initiatives taken for the implementation of the project (treatment) and the progress of the health of the beneficiary
                    </FormLabel>
                    <Textarea {...field} />
                    <FormErrorMessage>
                      {form.errors.initiativesTaken}
...
export default BiAnnualHealthIndividualReport;
