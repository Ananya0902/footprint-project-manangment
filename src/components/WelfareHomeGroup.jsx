...
const handleAddBudgetRow = () => {
  setBudgetRows([...budgetRows, { description: '', costsLastYear: '', budgetCurrentYear: '' }]);
};

// Function to calculate total costs for last year and current year
const calculateTotalCosts = (field) => {
  return budgetRows.reduce((total, row) => total + parseFloat(row[field]) || 0, 0).toFixed(2);
};
  ...
  const handleAddAchievement = (category) => {
    setAchievements((prevAchievements) => ({
      ...prevAchievements,
      [category]: [...prevAchievements[category], { description: "" }],
    }));
  };
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          name="totalChildren"
          onChange={(e) => handleChangeStatisticTable(e, "totalChildren")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) =>handleChangeStatisticTable(e, "rehabilitatedWithGuardians")}
          value={formData.rehabilitatedWithGuardians.previousYear || ""}
        />
      </Td>
      <Td>
        <Input
          ...
          name="rehabilitatedWithGuardians"
          onChange={(e) => handleChangeStatisticTable(e, "rehabilitatedWithGuardians")}
          value={formData.rehabilitatedWithGuardians.presentYear || ""}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeStatisticTable(e, "shiftedToOtherNGOs")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeStatisticTable(e, "pursuingHigherStudies")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          data-year="previousYear"
          name="settledInLife"
          onChange={(e) => handleChangeStatisticTable(e, "settledInLife")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeStatisticTable(e, "settledAndWorking")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          data-year="previousYear"
          name="otherCategory"
          onChange={(e) => handleChangeStatisticTable(e, "otherCategory")}
          ...
          <Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "childrenWithParents", "PreviousYear")}
                value={formData.personalSituation.childrenWithParentsPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "childrenWithParents", "PresentYear")}
                value={formData.personalSituation.childrenWithParentsPresentYear || ""}
              />
            </Td>
          </Tr>
          ...
          <Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "semiOrphans", "PreviousYear")}
                value={formData.personalSituation.semiOrphansPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "semiOrphans", "PresentYear")}
                value={formData.personalSituation.semiOrphansPresentYear || ""}
              />
            </Td>
          </Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "orphans", "PreviousYear")}
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "orphans", "PresentYear")}
          ...
          <Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "hivInfectedAffected", "PreviousYear")}
                value={formData.personalSituation.hivInfectedAffectedPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "hivInfectedAffected", "PresentYear")}
                value={formData.personalSituation.hivInfectedAffectedPresentYear || ""}
              />
            </Td>
          </Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "differentlyAbledChildren", "PreviousYear")}
                value={formData.personalSituation.differentlyAbledChildrenPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "differentlyAbledChildren", "PresentYear")}
                value={formData.personalSituation.differentlyAbledChildrenPresentYear || ""}
              />
            </Td>
          </Tr>
          ...
          <Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "parentsInConflict", "PreviousYear")}
                value={formData.personalSituation.parentsInConflictPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "parentsInConflict", "PresentYear")}
                value={formData.personalSituation.parentsInConflictPresentYear || ""}
              />
            </Td>
          </Tr>
          ...
          <Tr>
            ...
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "otherAliments", "PreviousYear")}
                value={formData.personalSituation.otherAlimentsPreviousYear || ""}
              />
            </Td>
            <Td>
              <Input
                ...
                onChange={(e) => handleChangePersonalSituation(e, "otherAliments", "PresentYear")}
                value={formData.personalSituation.otherAlimentsPresentYear || ""}
              />
            </Td>
          </Tr>
...
<Table variant="simple" mb={4}>
  ...
  <Tbody>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeEconomicBackground(e, "agriculturalLabour")}
    ...
    <Tr>
      <Td>
        Marginal farmers (Number of parents with less than two and a half acres of land)
      </Td>
      <Td>
        <Input
          type="number"
          name="marginalFarmers"
          onChange={(e) => handleChangeEconomicBackground(e, "marginalFarmers")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeEconomicBackground(e, "parentsSelfEmployed")}
          value={formData.economicBackground.parentsSelfEmployed || ""}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeEconomicBackground(e, "parentsInformalSector")}
          value={formData.economicBackground.parentsInformalSector || ""}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          type="number"
          name="anyOther"
          onChange={(e) => handleChangeEconomicBackground(e, "anyOther")}
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.fundScholarships.girls.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "fundScholarships", "girls", "previousYear")}
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.fundScholarships.girls.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "fundScholarships", "girls", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.fundScholarships.boys.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "fundScholarships", "boys", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          value={formData.multipleSupport.fundScholarships.boys.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "fundScholarships", "boys", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.tuitionClothing.girls.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "tuitionClothing", "girls", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          value={formData.multipleSupport.tuitionClothing.girls.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "tuitionClothing", "girls", "presentYear")}
          style={{ border: "1px solid #ccc, padding: 5px" }}
        />
      </Td>
    </Tr>
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.tuitionClothing.boys.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "tuitionClothing", "boys", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          value={formData.multipleSupport.tuitionClothing.boys.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "tuitionClothing", "boys", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.nutrition.girls.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "nutrition", "girls", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeMultipleSupport(e, "nutrition", "girls", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    <Tr>
      ...
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeMultipleSupport(e, "nutrition", "boys", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          onChange={(e) => handleChangeMultipleSupport(e, "nutrition", "boys", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.freeResidence.girls.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "freeResidence", "girls", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          value={formData.multipleSupport.freeResidence.girls.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "freeResidence", "girls", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
    <Tr>
      ...
      <Td>
        <Input
          ...
          value={formData.multipleSupport.freeResidence.boys.previousYear}
          onChange={(e) => handleChangeMultipleSupport(e, "freeResidence", "boys", "previousYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
      <Td>
        <Input
          ...
          value={formData.multipleSupport.freeResidence.boys.presentYear}
          onChange={(e) => handleChangeMultipleSupport(e, "freeResidence", "boys", "presentYear")}
          style={{ border: "1px solid #ccc", padding: "5px" }}
        />
      </Td>
    </Tr>
          ...
          <FormControl isRequired>
            <FormLabel>Describe the applied strategies to ensure the results and impact are long-lasting.</FormLabel>
            <Textarea
              name="sustainability"
          ...
          <FormControl isRequired>
            <FormLabel>Description of the steering and evaluation of the project (procedures, interval and responsibilities)</FormLabel>
            <Textarea
      ...
      <FormControl isRequired>
        <FormLabel>Provide an overview of the involved staff. How many sisters are working in the institution? How many lay staff members are there? What are the roles/jobs of the people? What is their educational background? Etc.</FormLabel>
        <Textarea
          name="staff"
            ...
            <Tr key={index}>
              ...
              <Td>
                <Input
                  ...
                  onChange={(e) => handleBudgetChange(index, 'costsLastYear', e.target.value)}
                />
              </Td>
              <Td>
                <Input
                  ...
                  onChange={(e) => handleBudgetChange(index, 'budgetCurrentYear', e.target.value)}
                />
              </Td>
            </Tr>
          ))}
    ...
    <Button colorScheme="teal" onClick={handleAddBudgetRow}>
      ...
      {/* Total Costs */}
        ...
        <FormControl mt={2}>
          ...
          <Input value={calculateTotalCosts('budgetCurrentYear')} isReadOnly />
        </FormControl>
