...
Personal Information of the Beneficiary
  ...
  <FormControl isRequired>
    <FormLabel>
      What is the impact created in the life of the beneficiary after initiating this livelihood business?
    </FormLabel>
    <Textarea
      name="impactInLife"
      onChange={handleChange}
  ...
  <FormControl isRequired>
    <FormLabel>Average Revenue Generated in the Previous Year</FormLabel>
    <Input
      type="text"
  ...
  <FormControl isRequired>
    <FormLabel>How is the Income Invested? Explain in Detail</FormLabel>
    <Textarea
